-- ============================================================
-- 010_COMPLETE_PORTAL_RPCS.SQL
-- Implement missing RPCs for Parent and Teacher portals.
-- These functions use SECURITY DEFINER to bypass RLS for portal users.
-- ============================================================
...
BEGIN
  RETURN QUERY
  SELECT 
    sp.id, sp.school_id, sp.name, sp.logo_url, sp.motto, sp.address, 
    sp.phone, sp.email, sp.website, sp.custom_exams, sp.grading_systems,
    sp.currency, sp.academic_year, sp.term_dates, sp.social_links
