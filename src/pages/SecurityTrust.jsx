    ...
    <PremiumLayout>
      ...
      <section className="section">
        <div className="sec-head reveal">
          ...
          <h2 className="landing-h2">Your school's intelligence,<br/><span className="h1-dim">protected by ShuleSoft Shield.</span></h2>
        ...
        <div className="feat-grid" style={{ marginTop: 60 }}>
          ...
          <div className="fc reveal reveal-delay-3">
            ...
            <p className="fc-desc">Our infrastructure is hosted on world-class, redundant servers, ensuring that ShuleSoft is ready for your teachers, students, and parents at any hour.</p>
          </div>
        </div>

        <div className="sec-head reveal" style={{ marginTop: 100 }}>
          <h3 className="landing-h2" style={{ fontSize: '2rem' }}>Our Privacy Promise</h3>
          <p className="sec-p">ShuleSoft will never sell or lease student data to third-party advertisers. Your data belongs to your school. We are merely the custodians of your digital excellence.</p>
        </div>
      </section>
    </PremiumLayout>
  );
