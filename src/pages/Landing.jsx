      ...
      <div className="nav-wrap">
        <nav className="landing-nav">
          ...
          <Link to="/book-demo" className="ncta">
            <span className="hide-sm">Book a </span>Demo
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-btns">
            ...
            <div className="dl-dropdown-w" style={{ position: 'relative', zIndex: 50 }}>
              <button 
                className="btn-s"
              ...
              {showDlDropdown && (
                <div className="portal-dropdown animate-pop" style={{ left: 0, right: 'auto', width: 260, top: 'calc(100% + 8px)' }}>
                  <a href="https://github.com/Termly-app/Termly.app/releases/download/v1.0.1/Termly-Setup-1.0.1.exe" className="pd-item" style={{ gap: 14 }}>
      ...
      <footer className="landing-footer">
        ...
        <div className="ft-grid-w">
          <div className="ft-col">
            ...
            <ul className="ft-links">
              ...
              <li><a href="https://github.com/Termly-app/Termly.app/releases/download/v1.0.1/Termly-Setup-1.0.1.exe" target="_blank" rel="noopener noreferrer">Download App</a></li>
            </ul>
          </div>
          <div className="ft-col">
        ...
        <div className="ft-ecosystem">
          ...
          <div className="ft-eco-links">
            ...
            <a href="https://github.com/Termly-app/Termly.app/releases/download/v1.0.1/Termly-Setup-1.0.1.exe" target="_blank" rel="noopener noreferrer">Desktop App</a>
          </div>
        </div>
