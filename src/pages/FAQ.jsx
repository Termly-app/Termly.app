...
export default function FAQ() {
  return (
    <PremiumLayout>
      <Helmet>
        <title>FAQ | Termly — Frequently Asked Questions</title>
        <meta name="description" content="Answers to common questions about Termly, CBC compliance, payments, offline use, data ownership, and teacher training." />
        <link rel="canonical" href="https://Termly.com/faq" />
      </Helmet>
      <section className="section">
        <div className="sec-head reveal">
          <div className="eyebrow">FAQ</div>
          <h2 className="landing-h2">Answers to your questions.</h2>
          <p className="sec-p">Everything you need to know about starting with Termly.</p>
        </div>

        <div className="faq-grid">
          <div className="faq-item reveal">
            <h3>Is Termly fully compliant with the Kenyan CBC?</h3>
          ...
          <div className="faq-item reveal reveal-delay-2">
            <h3>Can we use Termly without internet?</h3>
            <p>Termly is a cloud-native platform, ensuring your data is always backed up and accessible from any device. We recommend a stable 4G/5G or fiber connection for the best experience.</p>
          </div>

          <div className="faq-item reveal reveal-delay-3">
            <h3>What happens to our data if we stop using Termly?</h3>
