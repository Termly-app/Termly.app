...
export default function TermsOfService() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="March 2026">
      <Helmet>
        <title>Terms of Service | Termly</title>
        <meta name="description" content="Termly Terms of Service. Read about account registration, subscriptions, data usage, and governing law under Kenyan jurisdiction." />
        <link rel="canonical" href="https://Termly.com/legal/terms" />
      </Helmet>
      <section>
        <p>Welcome to Termly. These Terms of Service ("Terms") govern your use of the Termly school management platform. By registering a school account or accessing our services, you agree to comply with these terms.</p>
        
        <h3>1. Description of Service</h3>
        <p>Termly provides a cloud-based school management system for student records, academic grading (including CBC), and financial tracking with M-PESA integration.</p>
      </section>
      ...
      <section>
        ...
        <p>Termly is not liable for any unauthorized access resulting from your failure to secure your administrator credentials.</p>
      </section>

      <section>
        <h3>3. Subscription Plans & Payments</h3>
        <p>Access to Termly is provided on a termly subscription basis (Starter, Pro, or Elite). Subscriptions are charged per academic term.</p>
      ...
      <section>
        ...
        <p>Schools retain full ownership of the student and staff data they upload. Termly will not access, use, or share your school's data except to provide services, perform maintenance, or as required by law.</p>
      ...
      <section>
        ...
        <ul>
          <li>Use Termly for any illegal activity under Kenyan law.</li>
      ...
      <section>
        <h3>6. Termination</h3>
        <p>You may cancel your subscription at any time. Termly reserves the right to suspend or terminate accounts for non-payment or significant violation of these Terms.</p>
      </section>

      <section>
        <h3>7. Limitation of Liability</h3>
        <p>Termly is provided "as is". While we strive for 100% uptime, we are not liable for any operational disruption, loss of data, or financial loss resulting from the use or inability to use the platform.</p>
      </section>
      ...
      <section>
        ...
        <p>By using Termly, the School (Data Controller) appoints Termly (Data Processor) to process personal data in accordance with the <strong>Kenya Data Protection Act 2019</strong>. Termly shall only process data on the documented instructions of the School.</p>
      </section>

      <section>
        <h3>13. Acceptance of Terms</h3>
        <p>By creating an account or using Termly, you agree to these Terms of Service.</p>
      </section>
    </LegalLayout>
  );
}
