...
export default function SuperAdmin({ currentUser, sidebarOpen, setSidebarOpen, onSignOut }) {
  ...
  /* ── period-filtered data for overview lists ── */
  ...
  /* Revenue big chart — reacts to revPeriod */
  ...
  const navItems = [
    ...
    {id:'config',        ico:'⚙',  cls:'ni-d', label:'Settings'},
              ...
              {activeTab==='overview' && <div className="tv">
                ...
                <div className="kpi-grid">
                  {[
                    ...
                    {a:'var(--ro)',c:'ni-r',l:'Expired',              i:'⚠', v:expiredCount,           ch:expiredCount>0?'Follow-up needed':'All good',n:'SMS sent',up:false},
                      ...
                      : (q ? filteredSchools : recentSchools).slice(0,5).map((s,i)=>{
                          ...
                          return (
                            <div className="li" key={s.id}>
                              <div className="li-l"><div className={`li-ico ${cls}`}>🏫</div><div><div className="li-name">{s.name}</div><div className="li-sub">{p.subscription_plan||'Starter'} · {p.location||'Kenya'}</div></div></div>
              ...
              {deleteModal && (
                <div className="mb" style={{borderColor:'var(--ro)'}}>
                  ...
                  <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:20}}>
                    <div className="li-ico ni-r" style={{width:42,height:42,borderRadius:10,fontSize:20}}>☠</div>
                    <div>
