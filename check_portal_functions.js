...
async function checkPortalRPCs() {
  const functions = [
    'portal_get_class_students',
    'portal_get_teacher_papers',
    'portal_get_exam_marks',
    'portal_save_exam_marks'
  ];
  ...
  for (const fn of functions) {
    try {
      const { data, error } = await supabase.rpc(fn, { 
        ...
        p_class_id: '72628a28-b86e-4918-ae1b-c5c99140ddb9', // dummy
        p_teacher_id: '72628a28-b86e-4918-ae1b-c5c99140ddb9', // dummy
        p_exam_id: '72628a28-b86e-4918-ae1b-c5c99140ddb9', // dummy
